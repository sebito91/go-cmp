...
{teststructs.Eagle}.Slaps[0].Immutable.MildSlap:
	-: false
	+: true
{teststructs.Eagle}.Slaps[0].Immutable.LoveRadius.Summer.Summary.Devices[1|_]:
	-: "bar"
{teststructs.Eagle}.Slaps[0].Immutable.LoveRadius.Summer.Summary.Devices[2|_]:
	-: "baz"`,
	}}
}
...
func project2Tests() []test {
	...
	return []test{{
		...
		wantDiff: `
{teststructs.GermBatch}.DirtyGerms[18][0|_]:
	-: "germ2"
{teststructs.GermBatch}.DirtyGerms[18][_|2]:
	+: "germ2"`,
	}, {
		label: label,
		x:     createBatch(),
...
{teststructs.GermBatch}.DirtyGerms[18][2|_]:
	-: "germ4"
...
func project4Tests() []test {
	...
	return []test{{
		...
		opts: []cmp.Option{allowVisibility, transformProtos, cmp.Comparer(pb.Equal)},
		wantDiff: `
{teststructs.Cartel}.Headquarter.subDivisions[0|_]:
	-: "alpha"
...
{teststructs.Cartel}.poisons[0].poisonType:
	-: 1
	+: 5
{teststructs.Cartel}.poisons[1|_]:
